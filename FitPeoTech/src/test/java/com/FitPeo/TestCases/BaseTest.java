...
//		options.merge(cp);
	 ...
	 public void takeScreenshot(String tname) throws IOException
	   {
		   ...
		   File dst =new File("C:\\Users\\bobbi\\KCSA3\\Testing project\\FitPeoTech\\Screenshots"+Repname);
		   Files.copy(src, dst);
	 ...
	 public void actionsDD(WebDriver driver,WebElement element,int xValue, int yValue)
		{
